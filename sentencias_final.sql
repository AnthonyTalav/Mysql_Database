...
VALUES (1, 'Carrie','1974-01-01'),
      ...
      (1, 'La torre oscura 2 La invocacion','1987-01-01'),
      (1, 'Apocalipsis','1990-01-01'),
      (1, 'La torre oscura 3 Las tierras baldias','1991-01-01'),
      ...
      (1, 'La torre oscura 7 Cancion de Susannah','2004-01-01'),
      ...
      (3, 'El codigo Da Vinci', '2006-01-01'),
      (3, 'La consipiracion', '2003-01-01'),
      ...
      (5, 'El senior de los anillos','1954-01-01'),
